 ...
 * ================================
 * Настоящим я, Apolion, предоставляю право на использование данного плагина в 
 * любых целях, включая коммерческую эксплуатацию, монетизацию и модификацию 
 * кода.
 * 
 * Автор не несет ответственности за любые прямые или косвенные убытки, потерю 
 * данных или иные последствия, возникшие в результате использования или 
 * невозможности использования данного программного обеспечения. Пользователь 
 * принимает на себя все риски, связанные с функционированием плагина в своих 
 * проектах. Никаких претензий по поводу извлечения прибыли от использования 
 * данного продукта мною не предъявляется.
 * 
 * Автор: Apolion
 * 
 * 
